...
class RunnerConfig:
    ...
    #: %scf MaxDisk budget (MB) written into every window's input when the
...
class Config:
    ...
    #: Local development / mock mode without live Kaggle dependencies.
    local_mode: bool = _env_bool("ORCA_LOCAL_MODE", False)
